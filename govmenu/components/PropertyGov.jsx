...
import { MdCar } from 'react-ionicons'
import { MdGrid } from 'react-ionicons'
import { IosHome } from 'react-ionicons'
import { IosBoat } from 'react-ionicons'
import { MdBriefcase } from 'react-ionicons'
...
const PropertyGov = ({ setAlert }) => {
    ...
    const property = [{
        ...
        },
        {
            ...
            type: 2,
            children: < IosHome fontSize = "32px"
            color = "white" / > ,
            desc: `
        ...
        },
        {
            ...
            type: 3,
            children: < LogoDropbox fontSize = "32px"
            color = "white" / > ,
            desc: `
                <p class="accountmenu__content__cards__answer__text">
                    Колесо удачи – это рулетка, которую можно крутить каждый реальный день, отыграв всего 3 часа на сервере. Колесо удачи доступно в казино, среди выигрышей попадаются редкие маски, дорогие автомобиль или VIP.
        ...
        },
        {
            ...
            type: 4,
            children: < MdBriefcase fontSize = "32px"
            color = "white" / > ,
            desc: `
                <p class="accountmenu__content__cards__answer__text">
                    Колесо удачи – это рулетка, которую можно крутить каждый реальный день, отыграв всего 3 часа на сервере. Колесо удачи доступно в казино, среди выигрышей попадаются редкие маски, дорогие автомобиль или VIP.
        ...
        },
        {
            ...
            type: 5,
            children: < IosBoat fontSize = "32px"
            color = "white" / > ,
            desc: `
                <p class="accountmenu__content__cards__answer__text">
                    Колесо удачи – это рулетка, которую можно крутить каждый реальный день, отыграв всего 3 часа на сервере. Колесо удачи доступно в казино, среди выигрышей попадаются редкие маски, дорогие автомобиль или VIP.
